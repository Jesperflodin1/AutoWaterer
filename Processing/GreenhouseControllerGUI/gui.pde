...
public void connectionProgress(int progress) {
  StyledString loadingString = new StyledString("Ansluter till Arduino Uno... (" + progress + "%)");
...
public void createGUI(){
  ...
  panelLoading = new GPanel(this, 275, 175, 500, 200, "Ansluter till arduino");
  ...
  loadingLabel = new GLabel(this, 130, 75, 250, 50);
  loadingLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  loadingLabel.setText("Letar efter Arduino Uno...");
  loadingLabel.setOpaque(false);
  StyledString loadingString = new StyledString("Ansluter till Arduino Uno...");
  loadingString.addAttribute(TextAttribute.SIZE, 18);
  loadingLabel.setStyledText(loadingString);
  loadingLabel.setVisible(false);
  panelLoading.addControl(loadingLabel);
  serialList = new GDropList(this, 120, 80, 250, 140, 5, 25);
  ...
  savingLabel = new GLabel(this, 120, 75, 250, 50);
